...
sdf = cv2.cvtColor(dst, cv2.COLOR_BGR2GRAY)
...
th3 = cv2.adaptiveThreshold(sdf,255,cv2.ADAPTIVE_THRESH_GAUSSIAN_C,\
 	     cv2.THRESH_BINARY,11,2)
ret2,th4 = cv2.threshold(sdf,0,255,cv2.THRESH_BINARY+cv2.THRESH_OTSU)
